...
export default function NabvarContent(props) {
    ...
    return (
        <Row className='justify-content-center justify-content-md-between align-items-center pt-3'>
            ...
            <Col xs={4} md={1} className=" order-0 mt-3  d-flex justify-content-center">
                <div className="alert">
            ...
            <Col xs={4} md={1} className=" order-0 d-flex justify-content-center">
