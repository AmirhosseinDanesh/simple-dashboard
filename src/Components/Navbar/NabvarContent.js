...
export default function NabvarContent(props) {
    ...
    return (
        <div className='row justify-content-center justify-content-md-between align-items-center pt-3'>
            <div className="col-4 order-0 col-md-1 ">
            ...
            <div className="col-4 order-0 mt-3  col-md-1 d-flex justify-content-center">
                <div className="alert">
            ...
            <div className="col-4 order-0 col-md-1 d-flex justify-content-center">
