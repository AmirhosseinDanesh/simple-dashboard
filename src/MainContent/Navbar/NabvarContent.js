        ...
        <div className='row  pt-3'>
            ...
            <div className='col-md-6'>
                <div className="Navbar_input d-flex align-items-center  m-2 p-2 pe-5 ">
                    ...
                    <input type="text" className='ms-2 ' placeholder='Press / to search' />
                </div>
            </div>
            ...
            <div className="col-md-2 d-flex justify-content-end">
                <div className='Navbar_logout_icon m-2 pe-5' >
                    <button className='btn' type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Tooltip on top">
